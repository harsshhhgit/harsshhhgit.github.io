        ...
        <div className={styles.main}>
            <div className={styles.profile_card}>
                <a href="https://github.com/harsh1x4" className={styles.profile_img_link} target="blank">
                    <Image src="/{harsh}small.png" width={100} height={100} alt="Basic Logo" className={styles.profile_image}></Image>
                    {/* <Image src="/bg.svg" width={100} height={100} alt="Basic Logo" className={styles.profile_image}></Image> */}
                </a>
                <div className={styles.profile_wrapper} class="flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4 z-10 isolate">
