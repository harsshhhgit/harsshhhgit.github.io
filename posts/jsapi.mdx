...
# Spring Rest API
<PostImage
  alt='Spring REST API Architecture Diagram.'
  src='https://github.com/harsshhhgit/harsshhhgit.github.io/assets/93096721/51d36a35-b719-4c7b-9a26-554cf1f86a8f'
  width={1920}
  height={802}
/>
...
Let's start by creating a new spring project from [spring webiste](start.spring.io). I'll be using Java 17 and maven to create this spring project. 
<PostImage
